...
public static class EnumerableExtensions
{
    ...
    /// <remarks>
    /// This method determines whether the given collection is empty by using the <see cref="IEnumerable.GetEnumerator"/> method to get an enumerator for the collection, and then calling the <see cref="IEnumerator.MoveNext"/> method on the enumerator.
