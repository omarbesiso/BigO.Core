...
public static class QueryableExtensions
{
    ...
    /// <returns>
    ///     An <see cref="IQueryable{T}" /> with the predicate applied if the <paramref name="condition" /> is <c>true</c>
    ///     , or the original <paramref name="query" /> if the <paramref name="condition" /> is <c>false</c>.
    /// </returns>
    /// <example>
    ///     <code><![CDATA[
    ...
    /// </example>
    /// <remarks>
    ///     The <see cref="WhereIf{T}" /> method is useful when you want to conditionally apply a predicate to an
    ///     <see cref="IQueryable{T}" /> based on a boolean <paramref name="condition" />. If the <paramref name="condition" />
    ///     is <c>true</c>, the method applies the specified <paramref name="predicate" /> to the <paramref name="query" />. If
    ///     the <paramref name="condition" /> is <c>false</c>, the method returns the original <paramref name="query" />
    ///     without applying the <paramref name="predicate" />.
    /// </remarks>
