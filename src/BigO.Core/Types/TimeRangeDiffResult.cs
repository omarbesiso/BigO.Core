...
public struct TimeRangeDiffResult
{
    ...
    /// </summary>
    /// <param name="remainingTimeRange">The remaining time range when the other time range overlaps with the start or end of the current instance.</param>
    /// <param name="remainingBeforeRange">The remaining time range before the other time range when the current instance contains the other time range.</param>
    /// <param name="remainingAfterRange">The remaining time range after the other time range when the current instance contains the other time range.</param>
